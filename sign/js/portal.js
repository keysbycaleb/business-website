            ...
            <div class="contract-card ${contract.status}" data-contract-id="${contract.id}">
                ...
                <div class="contract-actions">
                    ${contract.status !== 'signed' ?
                        `<a href="index.html?id=${contract.id}" class="btn btn-primary btn-sm">
...
async function loadContractDetail(data) {
    ...
    try {
        ...
        if (contract.status !== 'signed') {
            actionsContainer.innerHTML = `
                <a href="index.html?id=${contract.id}" class="btn btn-primary">
            ...
            return `
                <div class="invoice-card ${statusClass}">
                    ...
                    <div class="invoice-info">
                        ...
                        <div class="invoice-description">${escapeHtml(invoice.description || 'Service Invoice')}</div>
                    ...
                    <div class="invoice-actions">
                        ${!isPaid && invoice.stripePaymentLink ?
                            `<a href="${invoice.stripePaymentLink}" target="_blank" class="btn btn-success btn-sm">
